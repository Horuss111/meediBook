...
// ✅ FIXED: Update these URLs when your real app is live
    ...
    <>
      <style jsx global>{`
        ...
        * { cursor: default; }
        ...
        /* ✅ FIXED: Added missing hero highlight text */
        ...
        /* ✅ FIXED: Hero stage hidden on mobile, shown on desktop only */
        ...
        /* ✅ FIXED: download-strip better mobile layout */
        ...
        /* ✅ FIXED: WhatsApp button moved to left so it doesn't overlap Chatbase (bottom-right) */
        ...
        /* ✅ FIXED: Comprehensive responsive breakpoints */
      ...
      <div className="page">
        ...
        <main>
          ...
          <section id="pricing" className="pricing-section">
            ...
            <div className="container pricing-inner">
              ...
              {/* ✅ FIXED: pricing note links to real contact */}
          ...
          <section id="download" className="section">
            <div className="container">
              <div className="download-strip">
                ...
                {/* ✅ FIXED: store buttons use correct URLs */}
        ...
        <footer id="contact" className="footer-wrap">
          <div className="container">
            <div className="footer-box">
              ...
              {/* ✅ FIXED: Privacy/Terms link to email instead of nowhere */}
        ...
        {/* ✅ FIXED: Moved to bottom-LEFT so it doesn't overlap Chatbase bot (bottom-right) */}
