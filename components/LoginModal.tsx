      ...
      <div style={{
          ...
          <div style={{
            ...
            <div style={{ width: 16, height: 16, display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 2 }}>
              {Array(9).fill(0).map((_,i) => (
                <span key={i} style={{ borderRadius: 2, background: "white", opacity: 0.9, display: "block" }} />
              ))}
            </div>
          </div>
          <div>
            <div style={{ fontFamily: "'Syne',sans-serif", fontWeight: 800, fontSize: 18 }}>MediBook</div>
            <div style={{ fontSize: 11, color: "rgba(255,255,255,0.4)", letterSpacing: "0.15em", textTransform: "uppercase" }}>Patient Portal</div>
          </div>
        </div>
        ...
        {step === "name" && (
          <>
            ...
            <p style={{ color: "rgba(255,255,255,0.5)", fontSize: 14, lineHeight: 1.6, marginBottom: 28 }}>
              What's your full name? This helps us personalize your experience.
            </p>
            <label style={{ display: "block", fontSize: 12, fontWeight: 700, color: "#93c5fd", letterSpacing: "0.1em", textTransform: "uppercase", marginBottom: 8 }}>
              Full Name
            </label>
